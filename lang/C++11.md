...
=================
   ...
   * [C++11](#c++11)
      ...
      * [noexcept](#noexcept)
      * [Konstante Ausdrücke (constexpr – constant expressions)](#konstante-ausdrücke-constexpr--constant-expressions)
...
```C++
constexpr auto arraySize = 10; // compile-time constant

// passt, da arraySize constexpr ist und der Compiler optimieren kann
std::array<int, arraySize> data; 
```

Und hier der Unterschied zu const. Const-Objekte müssen nicht zwingend mit Werten initialisiert werden, die zur Compile-Zeit bekannt sind.  
...
Viele Konzepte aus Boost sind in den C++11 Standard eingeflossen. Eine gute Übersicht liefert [1] in   Links. Viele Boost-Konzepte sind jetzt in der Standardbibliothek vorhanden und damit für Boost-Entwickler redundant.  
