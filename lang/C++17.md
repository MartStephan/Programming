...
Auf gut deutsch Operatoren mehrfach anwenden. Fold Expressions erlauben, alle Parameter einer variablen Liste von Template-Parameters hintereinander mit einem Operator zu verknüpfen.
...
| Attribut         | Bedeutung                                                    |
| ---------------- | ------------------------------------------------------------ |
| [[fallthrough]]  | Zeigt an, dass ein fall through eines switch-case Zweigs beabsichtigt ist und der Compiler deswegen nicht meckern sollte. |
| [[nodiscard]]    |                                                              |
| [[maybe_unused]] |                                                              |
