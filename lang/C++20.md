...
```c++
// This is the content of math.cppm
...
```C++
// This is our main.cpp using our math module 

// import declaration - this makes math-module functions visible
import math;

int main()
{   
   // just use math functions 
   add(2000, 20);
}
```
...
/// math.exe ist ausführbar - es funzt. 
```
